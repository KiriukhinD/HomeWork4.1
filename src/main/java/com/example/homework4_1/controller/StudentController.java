...
public class StudentController {
    ...
    @GetMapping("/studentFive")
    public Collection<Student> studentsFive() {
        return studentService.studentFive();
    }

    @GetMapping("/listNumber")
    public ResponseEntity<List<Avatar>> getAllExpensis(@RequestParam("page") Integer pageNumber,
